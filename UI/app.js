...
function init() {
    ...
    dz.on("complete", function (file) {
        ...
        $.post(url, {
            ...
            "class":"malala yousafzai",
            "class_dictionary":{"Aung Sang Suu Kyi":0,"malala yousafzai":1,"michelle obama":2,"oprah winfrey":3,"princess diana":4},
            "class_probability":[5.59,85.82,2.73,3.0,2.85]
            */
            console.log(data);
            ...
            let players = ["Aung Sang Suu Kyi", "malala yousafzai", "michelle obama", "oprah winfrey", "princess diana"];
